...
namespace Nop.Plugin.Misc.Cms.Controllers
{
    public partial class CmsTopicController : Nop.Web.Controllers.TopicController
    {
        #region Fields
        ...
        public CmsTopicController(ITopicModelFactory topicModelFactory,
            ITopicService topicService,
            ILocalizationService localizationService,
            IStoreMappingService storeMappingService,
            IAclService aclService,
            IPermissionService permissionService) : base(topicModelFactory, topicService, localizationService, storeMappingService, aclService, permissionService)
        {
        ...
        public override IActionResult TopicDetails(int topicId)
        {
        ...
        [HttpPost]
        [PublicAntiForgery]
        public override IActionResult Authenticate(int id, string password)
        {
