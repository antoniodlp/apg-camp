...
namespace Nop.Plugin.Misc.Cms.Areas.Admin.Controllers
{
    public partial class CmsTopicController : Nop.Web.Areas.Admin.Controllers.TopicController
    {
        #region Fields
        ...
        public CmsTopicController(ITopicService topicService,
            ...
            IAclService aclService) : base (topicService, languageService, localizedEntityService, localizationService, permissionService, storeService, storeMappingService, urlRecordService, topicTemplateService, customerService, customerActivityService, aclService)
        {
        ...
        protected override void PrepareTemplatesModel(TopicModel model)
        {
            if (model == null)
        ...
        protected override void UpdateLocales(Topic topic, TopicModel model)
        {
        ...
        protected override void PrepareAclModel(TopicModel model, Topic topic, bool excludeProperties)
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        protected override void SaveTopicAcl(Topic topic, TopicModel model)
        {
        ...
        protected override void PrepareStoresMappingModel(TopicModel model, Topic topic, bool excludeProperties)
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        protected override void SaveStoreMappings(Topic topic, TopicModel model)
        {
        ...
        [HttpPost]
        public override IActionResult List(DataSourceRequest command, TopicListModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageTopics))
        ...
        public override IActionResult Create(TopicModel model, bool continueEditing)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageTopics))
                return AccessDeniedView();
        ...
        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public override IActionResult Edit(TopicModel model, bool continueEditing)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageTopics))
                return AccessDeniedView();
